 ...
 * @since 1.4
 */
public class QuickFixDemoCipherInputStream extends FilterInputStream {
     ...
     */
    public QuickFixDemoCipherInputStream(InputStream is, Cipher c) {
        super(is);
        input = is;
        cipher = c;
    }
     ...
     * @param is the to-be-processed input stream
     */
    protected QuickFixDemoCipherInputStream(InputStream is) {
        super(is);
        input = is;
    ...
    public void close() throws IOException {
        ...
        try {
        	...
        	throw new QuickFixDemoInvalidCipherTextIOException(ex);
        }
        ostart = 0;
        ofinish = 0;
    }
    
    public static class QuickFixDemoInvalidCipherTextIOException extends IOException {
        public QuickFixDemoInvalidCipherTextIOException(Throwable cause) {
            super(cause);
        }    	
    }
